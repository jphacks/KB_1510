...
class Individual_messagesController extends AppController{
 ...
 public function beforeFilter(){
  ...
  public function whoview($id){
    $params = array(
        'order' => 'modified desc',
        'limit' => 20
      );
    $this->set('who', $this->Individual_message->findById($id,$params));
  }
  ...
  public function lists(){
    ...
    $this->set('message',$this->Indibidual_messages->find('all',$params));
  }
